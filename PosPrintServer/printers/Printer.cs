...
public class PrinterManager
{
    ...
    public static async Task<IntPtr> GetPrinterConnection(string ipAddress)
    {
    ...
    public static void PrintSymbol(IntPtr printer, string url) {
        ESCPOS.PrintSymbol(printer,49,url,48, 10, 10, 1);
        NewLine(printer);
    }
